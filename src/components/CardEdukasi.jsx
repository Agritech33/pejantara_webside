      ...
      <div className="card-1 w-full h-48 md:h-64 relative rounded-lg flex justify-center items-center">
        ...
        <div className="title absolute bottom-0">
          <div className="title-container flex flex-col items-center mb-5 gap-2">
            <h3 className="text-2xl font-bold text-accent px-3 py-1 bg-slate-100 bg-opacity-70 rounded-full">
              {title}
            </h3>
            <Link to={`/edukasi/${id}`}>
              <button className="py-2 px-4 bg-slate-600 rounded-full hover:bg-slate-700 hover:scale-105 transition-all duration-150 ease-in-out ">
                Baca Selengkap nya
              </button>
            </Link>
          </div>
