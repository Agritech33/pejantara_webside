      ...
      <main className="w-full py-10 md:py-28">
        ...
        <div className="flex flex-col md:flex-row gap-4 py-5 px-4 md:px-0">
          <div className="flex flex-col gap-4 flex-1">
            <div className="bg-[#16312B] text-white p-8 md:p-16 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-bold">Visi Pejantara</h2>
              </div>
            ...
            <div className="bg-cardlayanan text-gray-800 p-8 md:p-16 rounded-lg shadow-md">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-bold">Misi Pejantara</h2>
              </div>
          ...
          <div className="flex-1">
            <img src="tentangKami1.png" alt="A person wearing a beanie and glasses, picking up trash in a forested area" className="rounded-lg shadow-md w-full h-[320px] md:h-[480px] object-cover" />
          </div>
        </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col items-start gap-6">
              <img src="tentangKami2.png" alt="A hand holding a small plant with soil" className="rounded-lg shadow-md w-full" />
              <img src="tentangKami3.png" alt="A beach with trash bins and mountains in the background" className="rounded-lg shadow-md w-full h-auto" />
            </div>

            <div className="flex flex-col">
              <div>
                <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4">
                  Mengapa Harus <br /> Memilih <span className="text-secondary">Pejantara</span>
                </h1>
                <p className="text-gray-600 mb-4 text-sm md:text-base">Pejantara dipilih sebagai platform edukasi sampah dan pencarian TPA/TPS karena memiliki keunggulan yang relevan dengan kebutuhan pengelolaan sampah di masyarakat.</p>
              ...
              <div className="space-y-0">
                <div className="bg-cardlayanan p-8 md:p-20 rounded-t-lg shadow-md mb-2">
                  ...
                  <ol className="list-decimal list-inside text-gray-600 space-y-1 text-sm md:text-base">
                    <li>Membantu pemerintah mengatasi masalah overload sampah.</li>
                    <li>Mengembangkan Program Pengelolaan Sampah yang berbasis pemberdayaan masyarakat dan teknologi.</li>
                    <li>Menjadikan Batam sebagai kota yang bebas sampah dan ramah lingkungan.</li>
                  </ol>
                </div>
                <div className="bg-cardlayanan p-8 md:p-20 rounded-b-lg shadow-md">
                  ...
                  <ol className="list-decimal list-inside text-gray-600 space-y-1 text-sm md:text-base">
                    <li>Membantu Pemerintah Pusat dan Daerah dalam membuat kebijakan dalam bidang pembinaan, pengembangan, dan pengelolaan sampah.</li>
                    <li>Mengkoordinasikan organisasi kemasyarakatan yang bergerak di bidang lingkungan.</li>
